...
func (DownlinkTiming) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{0}
}
...
func (FineTimestampType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{1}
}
...
func (*FSKModulationInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{2}
}
...
func (*EncryptedFineTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{3}
}
...
func (*PlainFineTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{4}
}
...
func (*GatewayStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{5}
}
...
func (*UplinkRXInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{6}
}
...
func (*DownlinkTXInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{7}
}
...
func (*ImmediatelyTimingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{8}
}
...
func (dst *ImmediatelyTimingInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ImmediatelyTimingInfo.Merge(dst, src)
}
...
func (*DelayTimingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{9}
}
...
func (dst *DelayTimingInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DelayTimingInfo.Merge(dst, src)
}
...
func (*GPSEpochTimingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{10}
}
...
func (dst *GPSEpochTimingInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GPSEpochTimingInfo.Merge(dst, src)
}
...
func (*UplinkFrame) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{11}
}
...
func (*UplinkFrameSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{12}
}
...
func (*DownlinkFrame) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{13}
}
...
func (*DownlinkTXAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{14}
}
...
func (*GatewayConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{15}
}
...
func (*ChannelConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{16}
}
...
func (*LoRaModulationConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{17}
}
...
func (*FSKModulationConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_gw_7b748e34ae8d2efa, []int{18}
}
...
func init() { proto.RegisterFile("gw.proto", fileDescriptor_gw_7b748e34ae8d2efa) }

var fileDescriptor_gw_7b748e34ae8d2efa = []byte{
