...
func (*HandleUplinkMetaDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_nc_51b1434827cb844d, []int{0}
}
...
func (*HandleUplinkMACCommandRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_nc_51b1434827cb844d, []int{1}
}
...
func init() { proto.RegisterFile("nc.proto", fileDescriptor_nc_51b1434827cb844d) }

var fileDescriptor_nc_51b1434827cb844d = []byte{
