...
func (RXWindow) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_as_b85ddc3af5e26455, []int{0}
}
...
func (ErrorType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_as_b85ddc3af5e26455, []int{1}
}
...
func (*HandleProprietaryUplinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_as_b85ddc3af5e26455, []int{2}
}
...
func (*HandleErrorRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_as_b85ddc3af5e26455, []int{3}
}
...
func (*HandleDownlinkACKRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_as_b85ddc3af5e26455, []int{4}
}
...
func (*SetDeviceStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_as_b85ddc3af5e26455, []int{5}
}
...
func (*SetDeviceLocationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_as_b85ddc3af5e26455, []int{6}
}
...
func init() { proto.RegisterFile("as.proto", fileDescriptor_as_b85ddc3af5e26455) }

var fileDescriptor_as_b85ddc3af5e26455 = []byte{
	// 830 bytes of a gzipped FileDescriptorProto
	,
}
