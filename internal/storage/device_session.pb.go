...
func (*DeviceSessionPBChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_session_716818e3ac6de510, []int{0}
}
...
func (*DeviceSessionPBUplinkADRHistory) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_session_716818e3ac6de510, []int{1}
}
...
func (*DeviceSessionPBUplinkGatewayHistory) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_session_716818e3ac6de510, []int{2}
}
...
func (*DeviceSessionPB) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_session_716818e3ac6de510, []int{3}
}
...
func (*DeviceGatewayRXInfoSetPB) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_session_716818e3ac6de510, []int{4}
}
...
func (*DeviceGatewayRXInfoPB) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_session_716818e3ac6de510, []int{5}
}
...
func init() {
	proto.RegisterFile("device_session.proto", fileDescriptor_device_session_716818e3ac6de510)
}

var fileDescriptor_device_session_716818e3ac6de510 = []byte{
	...
	,
}
