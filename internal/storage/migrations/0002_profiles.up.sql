...
CREATE INDEX IF NOT EXISTS idx_device_device_profile_id on device(device_profile_id);
CREATE INDEX IF NOT EXISTS idx_device_service_profile_id on device(service_profile_id);
CREATE INDEX IF NOT EXISTS idx_device_routing_profile_id on device(routing_profile_id);
...
CREATE INDEX IF NOT EXISTS idx_device_activation_dev_eui on device_activation(dev_eui);
