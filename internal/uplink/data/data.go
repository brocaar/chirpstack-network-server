...
func resolveDeviceLocation(ctx *dataContext) error {
	...
	go func(devEUI lorawan.EUI64, geoClient geo.GeolocationServiceClient, asClient as.ApplicationServerServiceClient, rxInfo []*gw.UplinkRXInfo) {
	...
	}(ctx.DeviceSession.DevEUI, config.C.GeolocationServer.Client, ctx.ApplicationServerClient, rxInfoWithFineTimestamp)
