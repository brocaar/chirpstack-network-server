		...
		Convey("Given a set of test-scenarios for ADR", func() {
			tests := []uplinkTestCase{
				...
				},
				{
					...
					DeviceSession: nsExtraChannelsADR,
					RXInfo:        rxInfo,
					SetMICKey:     ns.NwkSKey,
					PHYPayload: lorawan.PHYPayload{
						MHDR: lorawan.MHDR{
