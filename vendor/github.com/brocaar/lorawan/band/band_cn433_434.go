...
func newCN433Band() (Band, error) {
	return Band{
		...
		UplinkChannels: []Channel{
			{Frequency: 434100000, DataRates: []int{0, 1, 2, 3, 4, 5}},
			{Frequency: 434300000, DataRates: []int{0, 1, 2, 3, 4, 5}},
			{Frequency: 434500000, DataRates: []int{0, 1, 2, 3, 4, 5}},
			{Frequency: 434700000, DataRates: []int{0, 1, 2, 3, 4, 5}},
			{Frequency: 433300000, DataRates: []int{0, 1, 2, 3, 4, 5}},
			{Frequency: 433500000, DataRates: []int{0, 1, 2, 3, 4, 5}},
			{Frequency: 433700000, DataRates: []int{0, 1, 2, 3, 4, 5}},
			{Frequency: 433900000, DataRates: []int{0, 1, 2, 3, 4, 5}},
		},
