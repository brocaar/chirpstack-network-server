...
func init() {
	...
	viper.SetDefault("network_server.network_settings.scheduler.scheduler_interval", 1*time.Second)
	viper.SetDefault("network_server.network_settings.class_c.downlink_lock_duration", 2*time.Second)
